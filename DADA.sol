...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 1 hours; // min 6 hour delay
...
contract SugarCardano is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Sugar Cardano";
    string constant _symbol = "DADA";
